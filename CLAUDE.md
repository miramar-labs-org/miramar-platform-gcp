...
| Create Project               | `create-project.yaml`               | Create platform repo (15 types: default/kfp/ft-eval/nemo-ft-eval/sequence-classify/serving-vllm/serving-nim/serving-llm-nim/serving-trt-fp8/serving-trt-engine/serving-triton-vllm/serving-triton-trtllm/kfp-rag/kfp-eval/kfp-nemo-curator); opens blog draft PR |
