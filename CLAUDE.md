...
| Delete Blog Post | `delete-blog-post.yaml` | Delete a post from `miramar-labs-org/miramar-labs-org.github.io` by filename; closes the draft PR and removes the draft branch. GitHub Pages rebuilds in ~60s. |
