...
| Build KFP arm64 Images   | `build-kfp-arm64-images.yaml`   | Build `kfp-metadata-writer` natively on the DGX arm64 runner and push to `ghcr.io/miramar-labs-org/kfp-metadata-writer:<version>-arm64`. Run before first Kubeflow Deploy or after a version bump. Input: `pipeline_version` (default `2.16.1`).                                                                                                                                                                                                                                                                                                                                                                                                           |
