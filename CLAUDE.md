...
| Create Project               | `create-project.yaml`               | Create platform repo (9 types: default/kfp/ft-eval/nemo-ft-eval/serving-vllm/serving-nim/serving-trt-fp8/serving-trt-engine/kfp-rag); opens blog draft PR |
