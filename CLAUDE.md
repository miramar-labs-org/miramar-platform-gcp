...
| Create Project               | `create-project.yaml`               | Create platform repo (11 types: default/kfp/ft-eval/nemo-ft-eval/serving-vllm/serving-nim/serving-llm-nim/serving-trt-fp8/serving-trt-engine/kfp-rag/kfp-nemo-curator); opens blog draft PR |
