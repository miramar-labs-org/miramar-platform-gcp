...
| Platform slash commands — `/kfp-deploy`, `/kfp-monitor`, `/model-card`, `/nsight-interpret`, `/handoff`, `/resume-handoff`, `/continue-handoff` | [kfp-skills.md](kfp-skills.md) | `~/.claude/commands/` on DGX |
