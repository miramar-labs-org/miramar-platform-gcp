...
def _make_profiled_component(func_name, src_orig, profiled_image, nsys_project, stage_name,
    ...
    return (
        ...
        f"        subprocess.run(['nsys', 'stats', '--force-export=true', str(nsys_rep)], stdout=out, stderr=subprocess.STDOUT)\n"
        ...
        f"                ['nsys', 'stats', '--force-export=true', '--report', report, str(nsys_rep)],\n"
        f"                stdout=out,\n"
